...
| CSA audit/run persistence                              | Define entities       | Provide settings inputs only                    | Implemented: migration, models, repositories, retention | Consume                                                   | Consume                                                    | Backup/recovery QA        | —                       |
...
| Audit drafts/runs/snapshots/populations               | CSA-03             | Implemented by `0017_combined_site_audit_persistence`; one-head migration tests, cascades/retention, restart-safe repositories, immutable history   |
