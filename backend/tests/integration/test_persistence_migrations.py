...
def test_migrated_schema_has_expected_tables_constraints_indexes_and_revision(  # noqa: PLR0915
    ...
    try:
        ...
        assert foreign_keys == {
            ...
            ("site_audits", "jobs"),
            ("site_audits", "runs"),
            ("site_audit_snapshots", "site_audits"),
            ("site_audit_rule_snapshots", "site_audit_snapshots"),
            ("site_audit_rule_snapshots", "site_audits"),
            ("site_audit_disabled_inherited_rules", "site_audit_snapshots"),
            ("site_audit_disabled_inherited_rules", "site_audits"),
            ("site_audit_urls", "site_audits"),
            ("site_audit_url_discovery_sources", "site_audit_urls"),
            ("site_audit_url_discovery_sources", "site_audits"),
            ("site_audit_url_populations", "site_audits"),
            ("site_audit_url_populations", "site_audit_urls"),
            ("site_audit_rule_matches", "site_audits"),
            ("site_audit_rule_matches", "site_audit_urls"),
            ("site_audit_rule_matches", "site_audit_rule_snapshots"),
            ("site_audit_findings", "site_audits"),
            ("site_audit_findings", "site_audit_urls"),
            ("site_audit_issue_groups", "site_audits"),
            ("site_audit_issue_group_memberships", "site_audit_issue_groups"),
            ("site_audit_issue_group_memberships", "site_audit_findings"),
            ("site_audit_issue_group_memberships", "site_audit_urls"),
            ("site_audit_module_statuses", "site_audits"),
