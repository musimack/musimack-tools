...
COMBINED_SITE_AUDIT_PERSISTENCE_REVISION = "0017_combined_site_audit_persistence"
COMBINED_SITE_AUDIT_ORCHESTRATION_REVISION = "0018_combined_site_audit_orchestration"
PERSISTENCE_HEAD_REVISION = COMBINED_SITE_AUDIT_ORCHESTRATION_REVISION
PERSISTENCE_HEAD_PARENT_REVISION = COMBINED_SITE_AUDIT_PERSISTENCE_REVISION
